...
; file fully replaces it rather than merging). The only change vs upstream is
; dropping `(#set! conceal_lines "")` on fenced code blocks, which crashes
; Neovim 0.12's conceal_line decoration provider with
